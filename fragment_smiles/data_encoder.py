...
train_df = pd.read_csv("train.sub_smiles.csv")
test_df = pd.read_csv("test.sub_smiles.csv")
...
df_train_encoder.to_pickle('train_sub_smiles.pickle')

df_test_encoder = pd.DataFrame()
df_test_encoder['smiles_encoder'] = test_res
df_test_encoder.to_pickle('test_sub_smiles.pickle')
